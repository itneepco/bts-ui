					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Bill Tracking Sstem - BTS",
									"targetURL": "#bts-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"bts-display": {
								"semanticObject": "bts",
								"action": "display",
								"description": "Bill Tracking System",
								"title": "Bill Tracking Sstem - BTS",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bts",
									"url": sap.ui.require.toUrl("bts")
								}
							}
						}
					}
